...
const Hero = () => {
    ...
    return ( <
        section className = "min-h-screen flex items-center justify-center relative overflow-hidden bg-background" > { /* Animated Background Elements */ } <
        ...
        <
        div className = "max-w-4xl mx-auto" > { /* Greeting */ } <
        motion.div initial = {
            { opacity: 0, y: 30 } }
        animate = {
            { opacity: 1, y: 0 } }
        ...
        <
        span className = "gradient-text" > Abhay Virus < /span> <
        /motion.h1>
        ...
        /h2> <
        p className = "text-lg md:text-xl text-accent/80 max-w-2xl mx-auto leading-relaxed" >
        Crafting digital experiences that blend creativity with cutting - edge technology.I build web applications that are not just functional, but extraordinary. <
        /p> <
        /motion.div>
