...
const Projects = () => {
    ...
    const projects = [
        {
            ...
            category: "fullstack",
            github: "https://github.com/abhayd95/ecommerce-platform",
        ...
        },
        {
            ...
            image: getRandomUnsplashImage('technology', { width: 600, height: 400 }),
            technologies: [
            ...
            category: "frontend",
            github: "https://github.com/abhayd95/task-manager",
        ...
        },
        {
            ...
            image: getRandomUnsplashImage('design', { width: 600, height: 400 }),
            technologies: [
                { name: "React", icon: FaReact, color: "#61DAFB" },
            ...
            category: "backend",
            github: "https://github.com/abhayd95/api-analytics",
        ...
        },
        {
            ...
            category: "mobile",
            github: "https://github.com/abhayd95/fitness-tracker",
        ...
        },
        {
            ...
            category: "fullstack",
            github: "https://github.com/abhayd95/chat-app",
    ...
    return (
        <section id="projects" className="py-20 bg-background-light relative overflow-hidden">
            {/* Background Elements */}
                            ...
                            {filteredProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        ...
                                        <p className="text-accent/70 text-sm mb-4 leading-relaxed">{project.description}</p>
                    ...
                    <motion.div variants={itemVariants} className="text-center mt-16">
                        <div className="glass p-8 rounded-2xl max-w-2xl mx-auto">
                            ...
                            <p className="text-accent/80 mb-6">
                                I'm always excited to work on new projects and bring ideas to life. Let's discuss your next big idea!
                            </p>
                            <motion.button
                                onClick={() => {
