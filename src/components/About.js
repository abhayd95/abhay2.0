...
import { FaCode, FaRocket, FaUsers, FaLightbulb, FaHeart, FaCoffee } from 'react-icons/fa';
...
const About = () => {
    ...
    return ( <
        ...
        A passionate full - stack developer who loves creating digital experiences that make a difference. <
        /p> <
        /motion.div>

        <
        div className = "grid lg:grid-cols-2 gap-16 items-center mb-20" > { /* Left Column - Text Content */ } <
        motion.div variants = { itemVariants }
        className = "space-y-6" >
        <
        ...
        Hey there!I 'm <span className="text-primary font-semibold">Abhay Virus</span>, a passionate 
        full - stack developer with a love
        for creating digital experiences that are both beautiful and functional. <
        /p> <
        p className = "text-lg text-accent/90 leading-relaxed" >
        With over 3 years of experience in web development, I specialize in modern JavaScript frameworks,
        particularly React and Node.js.I believe in writing clean, maintainable code and creating user experiences that leave a lasting impression. <
        /p> <
        p className = "text-lg text-accent/90 leading-relaxed" >
        When I 'm not coding, you'
        ll find me exploring new technologies, contributing to open - source projects,
        ...
        Powered by coffee☕ and fueled by curiosity <
        /span> <
        /motion.div> <
        /motion.div>
